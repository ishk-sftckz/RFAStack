...
import { user, account, session } from '@backend/features/auth/auth.table'
...
import { requireMembership, withMembership } from '@backend/features/membership/membership.queries'
import type { Membership } from '@backend/features/membership/model/membership.schema'
